            ...
            case SUCCESSFUL -> {
                ...
                sender.sendMessage(
                        config.getMessage(MESSAGE_TRANSFER_SEND)
                                .replace(REPLACE_MONEY, NumberFormatterHelper.numberToString(money, senderAccount.getFormatted()))
                ...
                receiverPlayer.sendMessage(
                        config.getMessage(MESSAGE_TRANSFER_RECEIVE)
                                .replace(REPLACE_MONEY, NumberFormatterHelper.numberToString(money, receiverAccount.getFormatted()))
