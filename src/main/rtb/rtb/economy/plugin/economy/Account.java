...
public final class Account implements Comparable<Account>{
    ...
    public boolean getFormatted() { return this.formattedNumber; }
    ...
    public String getNameWithPrefix() { return VaultChat.getPrefix(this.playerName) + this.playerName; }

    public String getName() { return this.playerName; }

    @Nullable
    public Player getPlayer() { return Bukkit.getPlayer(this.playerUUID); }

    public UUID getPlayerUUID() { return this.playerUUID; }

    public String getMoney() { return NumberFormatter.numberToString(this.money, this.formattedNumber); }

    public String getMoneyFormatted(BigDecimal moneyBigDecimal) { return NumberFormatter.numberToString(moneyBigDecimal, this.formattedNumber); }

    public String getMoney(boolean formatted) { return NumberFormatter.numberToString(this.money, formatted); }

    public String getMoneyPlainText() {
        return this.money.toPlainString();
    }

    public BigDecimal getMoneyAsBigDecimal() { return this.money; }
