...
public class InventoryClickEvents extends EventHelper {
    ...
    public void inventoryClick(InventoryClickEvent e) {
        ...
        if (!inv.getTitle().equalsIgnoreCase(config.getConfigString(INVENTORY_TITLE))) { return; }
    ...
    private enum TYPE {
        ...
        private boolean getFunction(Account account) {
            switch (this) {
                case TOGGLE: { return account.getToggle(); }
                case NUMBER_FORMAT: { return account.getFormatted(); }
