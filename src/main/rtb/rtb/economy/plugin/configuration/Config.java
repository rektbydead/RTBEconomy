...
public class Config extends ConfigHandler {
    ...
    public boolean getConfigBoolean(String value) {
        return defaultConfig.getBoolean(value);
    }

    public String getConfigString(String value) {
        return defaultConfig.getString(value).replace("&", "§");
    }

    public int getConfigInt(String value) {
        return defaultConfig.getInt(value);
    }
