...
import static rtb.economy.plugin.configuration.consts.ConstVariables.ECONOMY_SUFFIXES_LIST;
...
public final class NumberFormatter {
    ...
    static {
        NumberFormatter.suffixes = Config.getInstance().getConfigList(ECONOMY_SUFFIXES_LIST);
    }
