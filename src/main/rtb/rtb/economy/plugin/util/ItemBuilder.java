...
public final class ItemBuilder {
    ...
    /**
     * Replaces string in the lore.
     *
     * @param toBeReplaced to be replaced
     * @param replaceWith  to replace
     */
    public ItemBuilder replaceInLore(String toBeReplaced, String replaceWith) {
        ItemMeta im = is.getItemMeta();
        List<String> list = im.getLore();
        for (int i = 0; i < list.size(); i++) {
            list.set(i, list.get(i).replace(toBeReplaced, replaceWith));
        }
